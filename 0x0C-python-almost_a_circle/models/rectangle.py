...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args: width (int) - width of the rectangle
              height (int) - height of tje rectangle
              x (int) - the x coordinate of the new rectangle
              y (int) - the y coordinate of the new rectangle
              id (int) - identity of the new rectangle

        Raise: TypeError - the attributes must be integers
               ValueError - the attributes must be >= 0
        """
        self.width = width
        self.height = height
        self.x = x
    ...
    def display(self):
        """
        Prints rectangle to stdout represented by #
        """
